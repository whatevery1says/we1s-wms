(function ($) {
  $.fn.dateformat = function (settings) {
    ...
    html += '<a id="' + $(this).attr('id') + '_getdatevalue" role="button" class="btn btn-sm btn-outline-editorial" title="Submit"><i class="fa fa-check-circle"></i></a>'
    html += '</div>'
    html += '</div></li>'
    html += '</ol>'
    ...
    $('#add_date').on('click', function (e) {
      ...
      elem += '<div class="col-4"><input placeholder="Start Date" id="' + $(this).attr('id') + '_ds_0" name="0" size="16" type="text" value="" class="datepicker date"></div>'
      elem += '<div class="col-4"><input placeholder="End Date" id="' + $(this).attr('id') + '_de_0" name="0" size="16" type="text" value="" class="datepicker date"></div>'
