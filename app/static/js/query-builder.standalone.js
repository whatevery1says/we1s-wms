...
<dl id="{{= it.group_id }}" class="rules-group-container"> \
  <dt class="rules-group-header"> \
    <div class="btn-group pull-rightt group-actions"> \
      <button type="button" class="btn btn-sm btn-successs btn-outline-editorial" data-add="rule"> \
        <i class="{{= it.icons.add_rule }}"></i> {{= it.translate("add_rule") }} \
      </button> \
      {{? it.settings.allow_groups===-1 || it.settings.allow_groups>=it.level }} \
        <button type="button" class="btn btn-sm btn-successs btn-outline-editorial" data-add="group"> \
          <i class="{{= it.icons.add_group }}"></i> {{= it.translate("add_group") }} \
        </button> \
      {{?}} \
      {{? it.level>1 }} \
        <button type="button" class="btn btn-sm btn-dangerr btn-outline-editorial" data-delete="group"> \
    ...
    <div class="btn-group group-conditions"> \
      {{~ it.conditions: condition }} \
        <label data-cat="gemma" class="btn btn-sm btn-primaryy btn-outline-editorial"> \
...
<li id="{{= it.rule_id }}" class="rule-container"> \
  <div class="rule-header"> \
    <div class="btn-group pull-rightt rule-actions"> \
      <button type="button" class="btn btn-sm btn-dangerr btn-outline-editorial" data-delete="rule"> \
        ...
        switch (filter.input) {
            ...
            case 'checkbox':
                Utils.iterateOptions(filter.values, function(key, val) {
                    h += '<label' + c + '><input style="margin-right: 5px;" type="' + filter.input + '" name="' + name + '" value="' + key + '"> ' + val + '</label> ';
                });
                break;
