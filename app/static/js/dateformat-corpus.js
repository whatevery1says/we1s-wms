function dateformat_rawdata() {
  let el = 'updated_rawdata'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  ...
  let html = '<ol id="' + el + '_list" style="list-style-type: none; padding: 0; margin: 0">'
  html += '<li id="concatenate"><div class="row">'
  html += '<div class="col-4"><input placeholder="Start Date" id="' + el + '_ds_0" name="0" size="16" type="text" value="" class="datepicker date"></div>'
  html += '<div class="col-4"><input placeholder="End Date" id="' + el + '_de_0" name="0" size="16" type="text" value="" class="datepicker date"></div>'
  ...
  $(document).on('click', '.remove_date', function (e) {
    ...
    if ($(z).children().size() > 1) {
      ...
      document.getElementById('updated').value = s
      sessionStorage.setItem('updated', jsontify)
    }
    else {
...
function dateformat_processeddata() {
  let el = 'updated_processeddata'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
...
function dateformat_branch() {
  let el = 'updated_branch'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
...
function dateformat_generic() {
  let el = 'updated_generic'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
...
function dateformat_initcollection() {
  let el = 'updated_initcollection'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
  ...
  html += '<div class="col-4"><input placeholder="End Date" id="' + el + '_de_0" name="0" size="16" type="text" value="" class="datepicker date"></div>'
  html += '<div class="col-3" style="padding: 5px 5px;">'
  html += '<a id="init_add_date" role="button" class="btn btn-sm btn-outline-editorial" title="Add Date"><i class="fa fa-plus-circle"></i></a>'
  html += '<a role="button" class="remove_date btn btn-sm btn-outline-editorial" title="Remove Date"><i class="fa fa-minus-circle"></i></a>'
  html += '</div>'
  html += '</div></li>'
  html += '</ol>'
  ...
  $(document).on('click', '#init_add_date', function (e) {
    e.preventDefault()
    counter = counter + 1
    // let elem = '<li id="concatenate"><label class="col-form-label" for="ds_' + counter + '"></label><p class="datep" style="display:inline-block !important; width: 200px !important;">start date: <input id="' + $(this).attr('id') + '_ds_' + counter + '" name="' + counter + '" size="16" type="text" value="" class="datepicker date"></p><label class="col-form-label" for="de_' + counter + '"></label><p class="datep" style="display:inline-block !important; width: 200px !important;">end date: <input id="' + $(this).attr('id') + '_de_' + counter + '" name="' + counter + '" size="16" type="text" value="" class="datepicker date "></p><button type="button" class="remove_date btn btn-sm btn-outline-editorial">-</button></li>'
    let elem = '<li id="concatenate" style="padding-top: 5px;"><div class="row">'
    ...
    elem += '<div class="col-4"><input placeholder="End Date" id="' + k + '_de_' + counter + '" name=" ' + counter + ' " size="16" type="text" value="" class="datepicker date"></div>'
    elem += '<div class="col-3" style="padding: 10px 5px;">'
    elem += '<a id="init_add_date" role="button" class="btn btn-sm btn-outline-editorial" title="Add Date"><i class="fa fa-plus-circle"></i></a>'
    elem += '<a role="button" class="remove_date btn btn-sm btn-outline-editorial" title="Remove Date"><i class="fa fa-minus-circle"></i></a>'
    elem += '</div>'
    elem += '</div></li>'
...
function dateformat_create_initcollection() {
  let el = 'created_initcollection'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
  ...
  $(document).on('click', '.remove_date', function (e) {
    ...
    if ($(z).children().size() > 1) {
      ...
      jsontify = JSON.stringify(parsevalue)
      document.getElementById('updated').value = s
      sessionStorage.setItem('created', jsontify)
    }
    else {
      $(this).attr('disabled', 'disabled')
    }
...
function dateformat_create_collection() {
  let el = 'created_collection'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
  ...
  html += '<div class="col-4"><input placeholder="End Date" id="' + el + '_de_0" name="0" size="16" type="text" value="" class="datepicker date"></div>'
  html += '<div class="col-3" style="padding: 5px 5px;">'
  html += '<a id="collection_add_date" role="button" class="btn btn-sm btn-outline-editorial" title="Add Date"><i class="fa fa-plus-circle"></i></a>'
  html += '<a role="button" class="remove_date btn btn-sm btn-outline-editorial" title="Remove Date"><i class="fa fa-minus-circle"></i></a>'
  html += '</div>'
  html += '</div></li>'
  html += '</ol>'
  ...
  $(document).on('click', '#collection_add_date', function (e) {
    e.preventDefault()
    counter = counter + 1
    // let elem = '<li id="concatenate"><label class="col-form-label" for="ds_' + counter + '"></label><p class="datep" style="display:inline-block !important; width: 200px !important;">start date: <input id="' + $(this).attr('id') + '_ds_' + counter + '" name="' + counter + '" size="16" type="text" value="" class="datepicker date"></p><label class="col-form-label" for="de_' + counter + '"></label><p class="datep" style="display:inline-block !important; width: 200px !important;">end date: <input id="' + $(this).attr('id') + '_de_' + counter + '" name="' + counter + '" size="16" type="text" value="" class="datepicker date "></p><button type="button" class="remove_date btn btn-sm btn-outline-editorial">-</button></li>'
    let elem = '<li id="concatenate" style="padding-top: 5px;"><div class="row">'
    ...
    elem += '<div class="col-4"><input placeholder="End Date" id="' + k + '_de_' + counter + '" name=" ' + counter + ' " size="16" type="text" value="" class="datepicker date"></div>'
    elem += '<div class="col-3" style="padding: 10px 5px;">'
    elem += '<a id="collection_add_date" role="button" class="btn btn-sm btn-outline-editorial" title="Add Date"><i class="fa fa-plus-circle"></i></a>'
    elem += '<a role="button" class="remove_date btn btn-sm btn-outline-editorial" title="Remove Date"><i class="fa fa-minus-circle"></i></a>'
    elem += '</div>'
    elem += '</div></li>'
  ...
  $(document).on('click', '.remove_date', function (e) {
    ...
    if ($(z).children().size() > 1) {
      ...
      s = s.substring(0, s.length - 2)
      jsontify = JSON.stringify(parsevalue)
      document.getElementById('created').value = s
      sessionStorage.setItem('created', jsontify)
    }
    else {
      $(this).attr('disabled', 'disabled')
...
function dateformat_update_collection() {
  let el = 'updated_collection'
  var k = el
  let a = '#' + el + '_dateformat'
  let b = '#' + el + '_list'
  let adddate = '#' + k + '_add_date'
